...
|---|---|---|
| LLM Research | [PRISM-LLM](https://github.com/divyang4481/PRISM-LLM) | Memory-efficient LLM/Transformer experiments for low-VRAM training and inference. |
| OS Research | [Bharat-OS](https://github.com/CloudCarpentry/Bharat-OS) | Experimental OS architecture with per-core scheduling, memory protection, capabilities, and multi-arch support. |
| Materials AI | [nanobcp-ai](https://github.com/nayvidtechnology/nanobcp-ai) | ML inverse-design engine for block copolymer self-assembly and semiconductor lithography research. |
...
> _"Architecting cross-domain solutions where AI, cloud, digital transformation, business value, and next-generation compute come together."_
